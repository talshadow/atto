...
class UDPReciver : public bclasses::Enable_shared_from_this<UDPReciver> {
 public:
  static bclasses::Shared_ptr<UDPReciver> instance(bclasses::CBDataFunc &&filterFunction, bclasses::IO_service& service, unsigned short port);
  bool onRead(bclasses::MessageStruct&& msg, const bclasses::ErrorCode& code, size_t readSize);
